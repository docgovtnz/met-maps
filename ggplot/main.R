...
plt <- ggplot(nz.df) + geom_sf(fill="grey", alpha=0.3) +
  geom_polygon(data = mr.df, aes(x = long, y = lat, group = group), colour="#00ff00", fill="#00ff00", alpha=0.2) +
  coord_sf(xlim = c(176.2092899568599, 176.30032714224936), ylim = c(-37.245069509603134, -37.321945636347586)) +
  geom_point(data=df , aes(x=Long, y=Lat, size=H, colour=factor(Year)), alpha=0.5) +
...
plt
ggsave("./tuhua.png",width = 2200, height = 2200, units = "px" ,plot = plt, dpi = 300, type="cairo")
